...
from fastdm import __main__ as app_entry

MainWindow = app_entry.MainWindow


def test_application_entrypoint_startup_keeps_navigation_widgets_alive(tmp_path, monkeypatch):
